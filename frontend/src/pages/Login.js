      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-2">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-none">TaskFlow Executive</h1>
            <p className="text-base leading-relaxed text-muted-foreground">Sign in to manage your tasks</p>
          </div>
